    ...
    <div style={{ height: '151.01dvh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', alignItems: 'center' }} className="hidden">
      <div style={{ height: '150dvh', display: 'contents' }} className=''>
        ...
        <p id='hey-guys' className=''>
          Hey guys, My name is <span className='font-bold'>Abinav N</span> and I am a Second-year <span className='font-bold'>Electronics and Computer Science</span> student at <span className='font-bold'>VIT, Chennai</span>.<br />
