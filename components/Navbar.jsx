...
import { faBold, faHouse } from '@fortawesome/free-solid-svg-icons';
...
const Navbar = () => {
  return ( <div className="navbar">
    <a href="#home"><span className="flex flex-col items-center justify-center"><FontAwesomeIcon icon={faHouse} size='xs'/>Home</span></a>
        ...
        <a href="#skills"><span className="flex flex-col items-center justify-center"><FontAwesomeIcon icon={faBold} size='xs'/>Skills</span></a>
        </div>
  )
}
